...
const Settings = () => {
  return (
    <div className="min-h-screen">
      <div className="max-w-[65%] mx-auto p-6 flex flex-col gap-6">
        {/* Profile */}
          ...
          <div className="flex justify-between items-center py-4 border-b border-white/10">
            <div>
              ...
              <div className="text-white/50 text-[12px]">
                Store your past analyses for progress tracking
              </div>
            </div>
        ...
        {/* Security */}
        <div className="bg-black/50 border border-[#8E51FF80] rounded-xl p-6">
          <h2 className="text-white text-[24px] font-medium mb-5">Security</h2>
          <SecurityForm />
        </div>
        ...
        <div className="bg-black/50 border border-[#8E51FF80] rounded-xl p-6">
          ...
          <div className="flex justify-between items-center py-4 border-b border-white/10">
            <div>
              ...
              <div className="text-white/50 text-[12px]">
                Get notified about your analysis results
              </div>
            </div>
            <Switch defaultChecked className="custom-switch" />
          </div>
